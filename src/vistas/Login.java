...
public class Login extends JFrame{
	...
	//método para entrar al menu de usuario ********************
	private void Login() throws SQLException {
            ConsultasSQL nuevaSql = new ConsultasSQL();
            Usuarios usr = new Usuarios();
            String pass = new String(txtContrasena.getPassword());
            System.out.println("usuario de formulario: " + txtUsuario.getText());
            System.out.println("clave de formulario " + pass);
        //se valida cuando el usuario no este vacio y el campo contraseña no este vacio
        if(!txtUsuario.getText().equals("") && !pass.equals("")){
            usr.setUsuario(txtUsuario.getText());
            usr.setPassUsuario(pass);       
          
                if(nuevaSql.loginUsuario(usr)){
                    System.out.println("prueba");
                    MenuUsuario frmMenu = new MenuUsuario();
                    frmMenu.setVisible(true);
                    //this.dispose();
                }else{
                    JOptionPane.showMessageDialog(null, "Datos incorrectos por favor verifique");
                }              
